...
#ifndef GENERAL_UDP_SERVER_H
#define GENERAL_UDP_SERVER_H
 ...
 */
class GeneralUdpServer : public Application
{
public:
  static TypeId GetTypeId (void);
  GeneralUdpServer ();
  virtual ~GeneralUdpServer ();
  /**
...
private:
  ...
  std::vector<uint32_t> m_receivedSeq;
};

} // namespace ns3

#endif /* GENERAL_UDP_SERVER_H */
